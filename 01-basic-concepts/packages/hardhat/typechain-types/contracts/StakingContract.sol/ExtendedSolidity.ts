...
export interface ExtendedSolidityInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_PEOPLE"
      | "add"
  ...
  encodeFunctionData(
    functionFragment: "getInternalFunctionResult",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ExtendedSolidity extends BaseContract {
  connect(runner?: ContractRunner | null): ExtendedSolidity;
  waitForDeployment(): Promise<this>;

  interface: ExtendedSolidityInterface;
  ...
  getInternalFunctionResult: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "getInternalFunctionResult"
